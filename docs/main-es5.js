...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function start() {
          ...
          var challenge = document.getElementById('challenge-description');
          challenge.style.display = 'inline';
          var restart = document.getElementById('restart-section');
        ...
        value: function handleKeyboardEvent(event) {
          var startButton = document.getElementById('start-button'); // const headerText = document.getElementById('header-text');
        ...
        key: "rewriteText",
        value: function rewriteText() {
          var lastTypedIndex = this.typed.length - 1;
        ...
        key: "fixColors",
        value: function fixColors(position) {
        ...
        key: "createTextSection",
        value: function createTextSection() {
          var text1 = 'Learn one way to build applications with Angular and reuse your code and abilities to build apps for any deployment target. For web, mobile web, native mobile and native desktop.';
          var text2 = 'Achieve the maximum speed possible on the Web Platform right now, and take it further, via Web Workers and server-side rendering. Angular puts you in control over scalability right here.';
          var text3 = 'Meet data requirements by building data models on RxJS, Immutable.js or another push-model. From prototype through global deployment, Angular delivers the productivity and scalable infrastructure that supports Google\'s largest applications.';
          var possiblePhrases = [text1, text2, text3];
          var selectedTextindex = this.randomIntFromInterval(0, possiblePhrases.length - 1);
        ...
        key: "getCountertext",
        value: function getCountertext(seconds) {
          if (seconds < 60) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"])('document:keypress', ['$event'])], AppComponent.prototype, "handleKeyboardEvent", null);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/natanportilho/Documents/Projects/typist-dream/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
